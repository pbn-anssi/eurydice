...
[![badge_repo](https://img.shields.io/badge/ANSSI--FR-eurydice-white)](https://github.com/ANSSI-FR/eurydice)
...
*This projet is managed by [ANSSI](https://cyber.gouv.fr/). To find out more, you can visit the [page](https://cyber.gouv.fr/enjeux-technologiques/open-source/) (in French) dedicated to ANSSI’s open-source strategy. You can also click on the badges at the [top](https://github.com/ANSSI-FR/eurydice#TOP) to learn more about their meaning.*
